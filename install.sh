...
REPO="${DOCKERMGRREPO:-https://github.com/dockermgr}/traefik"
APPVERSION="$(__appversion "$REPO/raw/${GIT_REPO_BRANCH:-main}/version.txt")"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Defaults variables
APPNAME="traefik"
INSTDIR="$HOME/.local/share/dockermgr/traefik"
APPDIR="$HOME/.local/share/srv/docker/traefik"
DATADIR="$HOME/.local/share/srv/docker/traefik/files"
...
HUB_URL="casjaysdevdocker/traefik:latest"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
if [ -z "$HUB_URL" ] || [ "$HUB_URL" = "hello-world" ] || echo "$HUB_URL" | grep -q "traefik"; then
